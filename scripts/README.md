# design-comments - Integration Script

This script automatically integrates design-comments into a React app (works best with PatternFly React Seed or a similar structure).
